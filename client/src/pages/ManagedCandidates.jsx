...
const ManagedCandidates = () => {
  ...
  const getStatusStyle = (status) => {
    switch (status) {
      case "New Application": return "bg-yellow-400 text-white";
      case "Assessment": return "bg-yellow-400 text-white";
      case "Documentation": return "bg-yellow-400 text-white";
      case "Visa Processing": return "bg-yellow-400 text-white";
      case "Completed": return "bg-blue-400 text-white";
      case "Offer Received": return "bg-green-500 text-white";
