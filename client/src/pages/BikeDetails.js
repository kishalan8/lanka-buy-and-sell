          ...
          <div className="px-8 py-8 md:px-12">
            ...
            <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-6 gap-6">
              <div>
                ...
                <p className="text-gray-600 font-medium">{bike.brand}</p>
              </div>
              <span className="inline-block px-6 py-2 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-full text-sm font-semibold shadow-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              ...
              {bike.engine && (
                ...
                >
                  ...
                  <p className="font-semibold text-green-800">{bike.engine} cc</p>
                </motion.div>
              )}
              ...
              {bike.color && (
                ...
                >
                  ...
                  <p className="font-semibold text-yellow-800">{bike.color}</p>
                </motion.div>
              )}
            </div>
              ...
              <div className="mb-8">
                ...
                <ul className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  {bike.features.map((feat, idx) => (
                    <li
                      key={idx}
                      className="bg-gradient-to-r from-blue-50 to-indigo-50 p-3 rounded-2xl text-gray-700 font-medium text-sm text-center shadow-sm"
                    >
                      {feat}
                    </li>
                  ))}
