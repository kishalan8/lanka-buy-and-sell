...
import { X, User, Briefcase, Mail, Phone, Globe, Home, Flag, ChevronDown } from 'lucide-react';
...
const AddClientModal = ({ isOpen, onClose, onSave }) => {
  ...
  const visaStatusOptions = ['PR Approved', 'Work Visa', 'Assessment', 'Visa Expired', 'Blue Card', 'L1 Processing'];
                        ...
                        <div className="relative">
                          <div className="relative">
                            ...
                            <motion.div 
                              ...
                              initial="rest"
                              whileHover="hover"
                              animate={focusedField === 'contact' ? 'focus' : 'rest'}
                            >
                              <motion.div 
                                className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none"
                              >
                      ...
                      >
                        ...
                        <div>
                          ...
                          >
                            <select
                              ...
                              onChange={handleChange}
                              className={`w-full py-3 px-4 rounded-xl border-2 transition-all duration-300 appearance-none bg-white/80 backdrop-blur-sm ${
                                errors.country 
                                  ? 'border-red-300 focus:border-red-500 focus:ring-red-200' 
                                  : 'border-gray-200 focus:border-[var(--color-secondary)] focus:ring-[var(--color-secondary)]/20'
                        ...
                        <div>
                          ...
                          >
                            ...
                            <div className="absolute inset-y-0 right-0 flex items-center pr-4 pointer-events-none">
                              <Flag className="h-5 w-5 text-[var(--color-secondary)]" />
                            </div>
                          </motion.div>
                        </div>
                      </motion.div>
                          ...
                          <div>
                            ...
                            >
                              <input
                                ...
                                onBlur={() => setFocusedField(null)}
                                min="0"
                                className="w-full py-3 px-4 rounded-xl border-2 border-gray-200 focus:border-[var(--color-secondary)] focus:ring-4 focus:ring-[var(--color-secondary)]/20 focus:outline-none bg-white/80 backdrop-blur-sm transition-all duration-300"
                              />
                            </motion.div>
                          </div>
                          <div>
                            ...
                            <motion.div
                              ...
                              initial="rest"
                              whileHover="hover"
                              animate={focusedField === 'lastActivity' ? 'focus' : 'rest'}
                            >
                              <input
                                type="date"
                                name="lastActivity"
                                ...
                                onChange={handleChange}
                                onFocus={() => setFocusedField('lastActivity')}
                                onBlur={() => setFocusedField(null)}
                                className="w-full py-3 px-4 rounded-xl border-2 border-gray-200 focus:border-[var(--color-secondary)] focus:ring-4 focus:ring-[var(--color-secondary)]/20 focus:outline-none bg-white/80 backdrop-blur-sm transition-all duration-300"
                              />
                            </motion.div>
