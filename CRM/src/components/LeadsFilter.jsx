        ...
        <div className="flex gap-2 sm:gap-4 flex-wrap">
          {[
            ...
            { 
              ...
              options: ['All', 'Initial Contact', 'Assessment', 'Documentation', 'Visa Processing', 'Offer Received', 'Completed', 'Rejected'] 
            },
            { 
              label: 'Consultant', 
              value: assignedFilter, 
              setter: setAssignedFilter, 
              options: ['All', 'Sarah Johnson', 'Mike Chen', 'David Wilson', 'Emma Davis'] 
            }
          ].map((filter, index) => (
            <motion.div
              key={filter.label}
