...
import { X, User, Mail, Phone, Shield, Briefcase, Lock, ChevronDown, Check } from 'lucide-react';
                      ...
                      >
                        <div className="flex items-center justify-between">
                          ...
                          <button
                            ...
                            className="text-xs font-medium text-[var(--color-primary)] hover:text-[var(--color-secondary)] transition-colors"
                          >
                            ...
                            <div className="relative">
                              ...
                              >
                                <motion.div 
                                  className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none"
                                >
                                  <Check className="h-5 w-5 text-[var(--color-secondary)] z-1" />
                                </motion.div>
                                <input
                                  type="password"
