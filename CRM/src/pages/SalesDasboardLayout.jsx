...
const navItems = [
  ...
  { to: "/sales-dashboard/leads", label: "Leads", icon: ClipboardList },
  { to: "/sales-dashboard/client", label: "Clients", icon: Users },
  { to: "/sales-dashboard/mytasks", label: "Tasks", icon: CheckSquare },
  { to: "/sales-dashboard/reports", label: "Reports", icon: BarChart3 },
  { to: "/sales-dashboard/applications", label: "Applications", icon: BarChart3 },
  {
    label: "Job",
    icon: Shield,
    children: [
      { to: "/sales-dashboard/viewjob", label: "View Jobs", icon: UserCog },
      { to: "/sales-dashboard/addjob", label: "Add Jobs", icon: Settings },
    ]
  }
];
